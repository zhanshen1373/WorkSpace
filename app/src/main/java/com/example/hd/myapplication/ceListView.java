...
/**
 * Created by dubojian on 2017/9/27.
 */

public class ceListView extends ListView {
    ...
    public ceListView(Context context) {
        super(context);
        init();
    }

    public ceListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
